...
const ACTIVE_STATUSES = ["Approved", "Picked Up", "In Transit"];
    ...
    useCallback(() => {
      const fetchData = async () => {
        try {
          ...
          setRequests(data.filter((r) => ACTIVE_STATUSES.includes(r.status)));
        } catch (e) {
          console.log("Failed to fetch current bookings", e);
        } finally {
          setLoading(false);
        }
      };
    ...
    <LinearGradient colors={[COLORS.bgTop, COLORS.bgBottom]} style={{ flex: 1 }}>
      ...
      <View style={{ height: 180 }}>
        ...
        <View style={styles.headerText}>
          <Text style={styles.headerTitle}>Current Bookings</Text>
        </View>
      </View>
